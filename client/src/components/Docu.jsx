       ...
       <div className='grid grid-cols-11 mt-5 gap-3'>
            <div className='col-span-1'>
                <div className='flex flex-col w-full items-center justify-between '>
                  ...
                  <p className='font-inter ml-5 font-medium text-sm w-full text-slate-700'>{moment(date).format("MMM Do YYYY")}</p>
                </div>
            </div>
            ...
            <div className='col-span-1'>
                ...
                <p className='font-inter font-semibold text-sm  text-slate-500'>Time</p>
                  <p className='font-inter font-medium text-sm  text-slate-700'>{moment(time, "HH:mm").format("h:mm A")}
</p>
                </div>
            </div>
            < div  className='w-px h-8 ml-7 bg-slate-300' />
            <div className='col-span-2'>
                ...
                <p className='font-inter flex items-center justify-center font-medium text-sm  text-slate-700'>{doctorName}</p>
                </div>
            </div>
            < div  className='w-px h-8 ml-7 bg-slate-300' />
            <div className='col-span-1'>
                ...
                <p className='font-inter font-medium text-sm  text-slate-700'>{treatment}</p>
                </div>
            </div>
            < div  className='w-px h-8 ml-7 bg-slate-300' />
             <div className='col-span-2 '>
