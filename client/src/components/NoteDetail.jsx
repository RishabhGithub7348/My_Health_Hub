  ...
  return (
    ...
    <div className='grid grid-cols-8 m-3 gap-2'>
         ...
         <div className='flex flex-col gap-1 w-full items-center justify-between '>
              ...
              <p className='font-inter ml-5 font-medium text-sm w-full text-slate-800'>{moment(date).format("MMM Do YYYY")}</p>
            </div>
          </div>  
          ...
          <div className='col-span-1'>
            ...
            <p className='font-inter font-semibold text-sm  text-slate-500'>Time</p>
              <p className='font-inter font-medium text-sm  text-slate-800'>{moment(time, "HH:mm").format("h:mm A")}
          </p>
            </div>
        </div> 
        ...
        <div className='col-span-1'>
            ...
            <p className='font-inter font-semibold text-sm  text-slate-500'>Dr Name</p>
              <p className='font-inter font-medium text-sm  text-slate-800'>{doctorName}
            </p>
            </div>
        </div>
        ...
        <div className='col-span-1'>
            ...
            <p className='font-inter font-medium text-sm  text-slate-800'>{treatment}</p>
            </div>
        </div>
        ...
        <div className='col-span-1'>
            ...
            <p className='font-inter font-medium text-sm  text-slate-800'>{note}</p>
            </div>
        </div>
        <div className='col-span-1'>
            <div className='flex flex-col gap-1 w-full items-center justify-center '>
