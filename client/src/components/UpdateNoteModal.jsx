...
>
<div className='flex items-center justify-center te border-2 rounded-md'>
        <Input.TextArea rows={4} name='note' value={note.note} onChange={handleChange} placeholder="Enter your note here" />
